		...
		if (mysqli_num_rows($cek_layanan) == 0) {
			...
			if ($provider == "DG-PULSA" && $json_result['data']['status'] == "Gagal") {
				...
				if ($conn->query("INSERT INTO pembelian_pulsa VALUES ('','$order_id', '$provider_oid', '$sess_username', '" . $data_layanan['layanan'] . "', '" . $data_layanan['harga'] . "', '" . $data_rate['rate'] . "', '$koin', '$post_target', '', 'Pending', '$date', '$time', 'Website', '$provider', '0')") == true) {
					...
					$conn->query("INSERT INTO riwayat_saldo_koin VALUES ('', '$sess_username', 'Saldo', 'Pengurangan Saldo', '" . $data_layanan['harga'] . "', 'Mengurangi Saldo Top Up Melalui Pemesanan Saldo E-Wallet Dengan Kode Pesanan : WEB-$order_id', '$date', '$time')");
	...
	<div class="row">
		<div class="col-lg-7">
			<div class="kt-portlet">
				...
				<div class="kt-portlet__body">
					...
					$cek_kategori = $conn->query("SELECT * FROM kategori_layanan WHERE server = 'E-Money' ORDER BY nama ASC");
					?>
					<form class="form-horizontal" method="POST">
						<input type="hidden" name="csrf_token" value="<?php echo $config['csrf_token'] ?>">

						<input type="hidden" name="tipe" id="tipe" value="E-Money">
						...
						<div class="form-group row">
							...
							<div class="col-lg-9 col-xl-6">
								...
								<select class="form-control" name="operator" id="operator">
									...
									<?php while ($data_lay = $cek_kategori->fetch_assoc()) { ?>
										<option value="<?php echo $data_lay['kode']; ?>"><?php echo $data_lay['nama']; ?></option>
									<?php }  ?>
						...
						<div class="form-group row">
							...
							<div class="col-lg-9 col-xl-6">
								<input type="number" name="target" class="form-control" placeholder="Nomor HP">
						...
						<div class="form-group row">
							...
							<div class="col-lg-9 col-xl-6">
								<div class="input-group">
									...
									<input type="number" class="form-control bg-secondary" id="harga" placeholder="0" readonly disabled="">
								</div>
								<div id="koin"></div>
							</div>
						</div>
		...
		<div class="col-lg-5">
			<div class="kt-portlet">
				...
				<div class="kt-portlet__body">
					<ul>
						<li>Pesan Saldo E-Wallet Masukkan Nomor HP Dengan Benar, Contoh 085600xxx245.</li>
