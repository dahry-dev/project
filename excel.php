...
header("Content-Disposition: attachment; filename=Buku Laporan Keuangan " . $web['nama'] . ".xls");
...
<table class="table table-hover">
    <thead>
        <tr>
            <th colspan=6 height="60px">Laporan Keuangan</th>
        </tr>
        <tr>
            <th colspan=6 height="60px"><?= $web['nama'] ?></th>
        </tr>
        <tr>
            <th colspan=6 height="60px">Periode Bulan : <?= date_format($date1, " F Y") ?> - <?= date_format($date2, "F Y")  ?></th>
        </tr>
