	...
	<div class="row">
		<div class="col-lg-7">
			<div class="kt-portlet">
				...
				<div class="kt-portlet__body">
					...
					$cek_kategori = $conn->query("SELECT * FROM kategori_layanan WHERE server = 'Voucher' ORDER BY nama ASC");
					?>
					<form class="form-horizontal" method="POST">
						<input type="hidden" name="csrf_token" value="<?php echo $config['csrf_token'] ?>">
						<input type="hidden" name="tipe" id="tipe" value="Voucher">
						...
						<div class="form-group row">
							...
							<div class="col-lg-9 col-xl-6">
								<input type="number" name="target" class="form-control" placeholder="ID Game">
						...
						<div class="form-group row">
							...
							<div class="col-lg-9 col-xl-6">
								<div class="input-group">
									...
									<input type="text" class="form-control bg-secondary" id="harga" placeholder="0" readonly disabled="">
								</div>
								<div id="koin"></div>
							</div>
						</div>
		...
		<div class="col-lg-5">
			<div class="kt-portlet">
				...
				<div class="kt-portlet__body">
					<ul>
						<li>Pesan Voucher Masukkan Nomor HP Dengan Benar, Contoh 085600xxx245.</li>
